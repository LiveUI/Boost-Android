...
class WorkspaceListActivity : BoostActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setNavigator(navigationViewModel, R.id.fragment_container)

        navigationViewModel.mainNavigator.replaceFragment(FragmentNavigationItem(clazz = WorkspaceListFragment::class.java))
    }

    companion object {
        fun startActivity(context: Context) {
            context.startActivity(Intent(context, WorkspaceListActivity::class.java).apply {
